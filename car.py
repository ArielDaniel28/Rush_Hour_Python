class Car:
    ...
    def car_coordinates(self):
        ...
        if self.__car_orientation==1:
            for i in range(self.__car_length):
                coordinates_list.append((self.__car_location[0][0], self.__car_location[0][1]+i))
        elif self.__car_orientation==0:
            for i in range(self.__car_length):
                add_coordinate=(self.__car_location[0][0]+i, self.__car_location[0][1])
    ...
    def possible_moves(self):
        ...
        """
        vertical_moves={'u': "cause the car to move one step up", 'd': "cause the car to move one step down"}
        horizontal_moves={'l': "cause the car to move one step left", 'r': "cause the car to move one step right"}
        if self.__car_orientation==1:
    ...
    def movement_requirements(self, movekey):
        ...
        required_cell=[]
        if movekey=='u':
            required_cell.append((self.__car_location[0][0]-1, self.__car_location[0][1]))
            return required_cell
        if movekey=='d':
            required_cell.append((self.__car_location[0][0]+1, self.__car_location[0][1]))
            return required_cell
        if movekey=='l':
            required_cell.append((self.__car_location[0][0], self.__car_location[0][1]-1))
            return required_cell
        if movekey=='r':
            required_cell.append((self.__car_location[0][0], self.__car_location[0][1]+1))
            return required_cell
