...
class Game:
    ...
    def __single_turn(self):
        ...
        user_input=input("Please Choose the car you want to move and the direction.\nIf you want to exit please press '!' ")
        if user_input=="!":
            print("Bye Bye!")
            return
...
def is_car_valid(car_name, car_length, car_coordinate, car_orientation, game_board):
    ...
    for coordinate in car_coordinate:
        if coordinate[0]<0 or coordinate[0]>BOARD_LENGTH-1 or coordinate[1]<0 or coordinate[1]>BOARD_LENGTH-1:
            return False
...
if __name__== "__main__":
    ...
    for current_car in all_cars_dictionary:
        ...
        if is_car_valid(car_name, car_length, car_location, car_orientation, game_board):
            game_board.add_car(car.Car(car_name, car_length, car_location, car_orientation))
